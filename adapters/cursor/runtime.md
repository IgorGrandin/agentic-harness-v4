...
- Cursor recommends Auto for the root, but host/user choice always wins. Native subagents use `model: inherit` and provider-managed reasoning/effort; this adapter never pins a provider model or fixed effort tier.
